...
contract Barangay {
    ...
    // ) external returns (bool) {
    //     require(authorOfBrgy[brgyId] == msg.sender, "Unauthorized entity");
    ...
    //             delBarangayOf[brgyId] = authorOfBrgy[brgyId];
    //             delete activeBarangay[i];
    //             delete authorOfBrgy[brgyId];
    //         }
    //     }
    ...
    //             authorOfBrgy[brgyId] = delBarangayOf[brgyId];
