...
export const tokenAddress = "0xBF41E24523fCC7E3667B76EA5aE35913a916b789"
export const abi = [
	{
		"inputs": [],
	...
	},
	{
		...
		"inputs": [
			...
			{
				"indexed": false,
				"internalType": "enum Pine.DeactivatedBrgy",
				"name": "deleted",
				"type": "uint8"
			},
			{
	...
	},
	{
		...
		"inputs": [
			...
			{
				"indexed": false,
				"internalType": "enum Pine.Deactivated",
				"name": "deleted",
				"type": "uint8"
			},
			{
		...
		"outputs": [
			{
				...
				"internalType": "struct Pine.BarangayStruct[]",
				"name": "",
				"type": "tuple[]"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct Pine.RequestStruct[]",
				"name": "",
				"type": "tuple[]"
			}
		],
